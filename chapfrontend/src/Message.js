        ...
        <div className="messageDiv"> 
            ...
            <div className="row">
                <div className="col-sm-2 col-2" id="listFrame">
                    UserList:
                    <ul className="userList list-group" id='userListOutfit'>{user.map((user, index) => <li className={userItself(user)} key={index}>{user}</li>)}</ul>
                </div>
                <div className="col-sm-9 col-9" id="messageHolder">
                    {messages.map((words, index) =>
                        <div key={index}> 
                            <div className={chat(words.user)}>{words.text}
                            </div>
            ...
            <div className="row h-25">
                ...
                <div className="col-sm-8 col-4" id="sendMessagePart">   
                    <div className='row' id="messageDiv">
                        <input type="text" placeholder="Send Message here" onChange={onChange} className="inputMessage" value={sendMessage}></input>
                    </div>
                </div>
                <div className="col-sm-3 col-3" id="messageAndButton">
                    ...
                    <div className="col">
                        <div className="row" id="sendDiv">             
                            <Button onClick={toServer} variant="contained" color="primary" endIcon={<SendIcon></SendIcon>}>Send</Button> 
                        </div> 
                        <div className="row">   
                            <Button onClick={leave} variant="contained" color="secondary" endIcon={<ExitToAppIcon></ExitToAppIcon>}>Leave</Button> 
                        </div>
                    </div>
